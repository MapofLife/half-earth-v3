...
vi.mock(
  ...
  () => ({
    SECTION_INFO: { SII_PROVINCE_VIEW: 'province view' },
  })
);

describe('Sii ProvinceChartComponent', () => {
  it('renders province ranking summary and line chart', async () => {
    ...
    render(
      <LightModeContext.Provider value={{ lightMode: false }}>
        <ProvinceChartComponent
          ...
          provinces={[
            {
              ...
              sii_rank: 8,
              size_rank: 4,
              richness_vert_sii_rank: 3,
              richness_vert_spi_rank: 5,
            },
            {
              name: 'Loreto',
              iso3: 'PER',
          ...
          countryISO="PER"
          lang="en"
          view={{ map: { allLayers: [{ id: 'PER-sii', visible: true }] } }}
    ...
    render(
      <LightModeContext.Provider value={{ lightMode: false }}>
        <ProvinceChartComponent
          ...
          countryISO="EE"
          lang="en"
          view={{ map: { allLayers: [{ id: 'EE-sii', visible: true }] } }}
          regionLayers={[{ id: 'region-layer' }]}
        />
      </LightModeContext.Provider>
    );
