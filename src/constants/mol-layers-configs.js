...
export const layersConfig = {
  ...
  [AMPHIB_RARITY_NATIONAL]: {
    title: AMPHIB_RARITY_NATIONAL,
    slug: AMPHIB_RARITY_NATIONAL,
    type: LAYER_TYPES.TILE_LAYER,
    url: LAYERS_URLS[AMPHIB_RARITY_NATIONAL],
    bbox: null,
  },
  [BIRD_RARITY_NATIONAL]: {
    title: BIRD_RARITY_NATIONAL,
    slug: BIRD_RARITY_NATIONAL,
    type: LAYER_TYPES.TILE_LAYER,
    url: LAYERS_URLS[BIRD_RARITY_NATIONAL],
    bbox: null,
  },
  [MAMMAL_RARITY_NATIONAL]: {
    title: MAMMAL_RARITY_NATIONAL,
    slug: MAMMAL_RARITY_NATIONAL,
    type: LAYER_TYPES.TILE_LAYER,
    url: LAYERS_URLS[MAMMAL_RARITY_NATIONAL],
    bbox: null,
  },
  [REPTILE_RARITY_NATIONAL]: {
    title: REPTILE_RARITY_NATIONAL,
    slug: REPTILE_RARITY_NATIONAL,
    type: LAYER_TYPES.TILE_LAYER,
    url: LAYERS_URLS[REPTILE_RARITY_NATIONAL],
    bbox: null,
  },
  [AMPHIB_RICHNESS_NATIONAL]: {
    title: AMPHIB_RICHNESS_NATIONAL,
    slug: AMPHIB_RICHNESS_NATIONAL,
    type: LAYER_TYPES.TILE_LAYER,
    url: LAYERS_URLS[AMPHIB_RICHNESS_NATIONAL],
    bbox: null,
  },
  [BIRD_RICHNESS_NATIONAL]: {
    title: BIRD_RICHNESS_NATIONAL,
    slug: BIRD_RICHNESS_NATIONAL,
    type: LAYER_TYPES.TILE_LAYER,
    url: LAYERS_URLS[BIRD_RICHNESS_NATIONAL],
    bbox: null,
  },
  [MAMMAL_RICHNESS_NATIONAL]: {
    title: MAMMAL_RICHNESS_NATIONAL,
    slug: MAMMAL_RICHNESS_NATIONAL,
    type: LAYER_TYPES.TILE_LAYER,
    url: LAYERS_URLS[MAMMAL_RICHNESS_NATIONAL],
    bbox: null,
  },
  [REPTILE_RICHNESS_NATIONAL]: {
    title: REPTILE_RICHNESS_NATIONAL,
    slug: REPTILE_RICHNESS_NATIONAL,
    type: LAYER_TYPES.TILE_LAYER,
    url: LAYERS_URLS[REPTILE_RICHNESS_NATIONAL],
    bbox: null,
  },
  [BIRDS_SACA_RICHNESS_TOTAL]: {
